...
export function Footer() {
  ...
  return (
    <footer className="bg-titote-brown text-white">
      {/* Main Footer */}
      <div className="mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-[100px]">
        <div className="grid grid-cols-2 gap-10 md:grid-cols-4 lg:gap-16">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-white/70">
              {locale === 'es'
                ? 'Cocina cartagenera fusionada con sabores de Oriente en el corazón de Getsemaní.'
                : 'Cartagena cuisine fused with Oriental flavors in the heart of Getsemaní.'}
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mb-6 flex gap-4">
              <a
                ...
                className="hover:bg-titote-gold/20 flex h-10 w-10 items-center justify-center rounded-full bg-white/10 transition-colors"
